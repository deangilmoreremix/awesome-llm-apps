"""
Main entry point for tree - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/single_agent_apps/windows_use_autonomous_agent/windows_use/tree')
