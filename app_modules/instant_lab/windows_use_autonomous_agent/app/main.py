"""
Main entry point for windows_use_autonomous_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/single_agent_apps/windows_use_autonomous_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'main.py')
