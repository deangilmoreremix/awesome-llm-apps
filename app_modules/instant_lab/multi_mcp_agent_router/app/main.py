"""
Main entry point for multi_mcp_agent_router - Instant Lab App
...
agent_path = os.path.join(project_root, './mcp_ai_agents/multi_mcp_agent_router')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'agent_forge.py')
