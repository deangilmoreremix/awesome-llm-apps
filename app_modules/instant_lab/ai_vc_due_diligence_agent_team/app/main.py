"""
Main entry point for ai_vc_due_diligence_agent_team - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/agent_teams/ai_vc_due_diligence_agent_team')
