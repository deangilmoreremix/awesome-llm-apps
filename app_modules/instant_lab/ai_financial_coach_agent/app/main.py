"""
Main entry point for ai_financial_coach_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/ai_financial_coach_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'ai_financial_coach_agent.py')
