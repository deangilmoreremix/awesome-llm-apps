"""
Main entry point for multi_agent_trust_layer - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/multi_agent_trust_layer')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'multi_agent_trust_layer.py')
