"""
Main entry point for adapters - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/devpulse_ai/adapters')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'medium.py')
