"""
Main entry point for ai_reasoning_agent - Instant Lab App
...
agent_path = os.path.join(project_root, 'starter_ai_agents', 'ai_reasoning_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'reasoning_agent.py')
