"""
Main entry point for customer_support_voice_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './voice_ai_agents/customer_support_voice_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'customer_support_voice_agent.py')
