"""
Main entry point for local_hybrid_search_rag - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/local_hybrid_search_rag')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'local_main.py')
