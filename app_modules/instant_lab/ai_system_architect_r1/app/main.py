"""
Main entry point for ai_system_architect_r1 - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/single_agent_apps/ai_system_architect_r1')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'ai_system_architect_r1.py')
