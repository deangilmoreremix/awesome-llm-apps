"""
Main entry point for rag_agent_cohere - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/rag_agent_cohere')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'rag_agent_cohere.py')
