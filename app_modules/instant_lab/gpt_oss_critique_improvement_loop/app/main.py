"""
Main entry point for gpt_oss_critique_improvement_loop - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_llm_apps/gpt_oss_critique_improvement_loop')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'streamlit_app.py')
