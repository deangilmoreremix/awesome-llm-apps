"""
Main entry point for ai_deep_research_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/single_agent_apps/ai_deep_research_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'deep_research_openai.py')
