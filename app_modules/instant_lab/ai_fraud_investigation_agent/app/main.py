"""
Main entry point for ai_fraud_investigation_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/single_agent_apps/ai_fraud_investigation_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'fraud_investigation_agent.py')
