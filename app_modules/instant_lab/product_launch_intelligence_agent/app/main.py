"""
Main entry point for product_launch_intelligence_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/product_launch_intelligence_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'product_launch_intelligence_agent.py')
