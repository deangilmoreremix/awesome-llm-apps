"""
Main entry point for rag-as-a-service - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/rag-as-a-service')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'rag_app.py')
