"""
Main entry point for autonomous_rag - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/autonomous_rag')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'autorag.py')
