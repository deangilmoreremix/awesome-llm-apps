"""
Main entry point for ai_life_insurance_advisor_agent - Instant Lab App
...
agent_path = os.path.join(project_root, 'starter_ai_agents', 'ai_life_insurance_advisor_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'life_insurance_advisor_agent.py')
