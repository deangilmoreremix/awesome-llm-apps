"""
Main entry point for deepseek_local_rag_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/deepseek_local_rag_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'deepseek_rag_agent.py')
