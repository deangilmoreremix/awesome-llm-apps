"""
Main entry point for local_chatgpt_with_memory - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_llm_apps/llm_apps_with_memory_tutorials/local_chatgpt_with_memory')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'local_chatgpt_memory.py')
