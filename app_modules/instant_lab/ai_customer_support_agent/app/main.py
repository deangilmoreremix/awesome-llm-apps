"""
Main entry point for ai_customer_support_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/single_agent_apps/ai_customer_support_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'customer_support_agent.py')
