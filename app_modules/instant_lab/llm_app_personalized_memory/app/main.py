"""
Main entry point for llm_app_personalized_memory - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_llm_apps/llm_apps_with_memory_tutorials/llm_app_personalized_memory')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'llm_app_memory.py')
