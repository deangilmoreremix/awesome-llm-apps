"""
Main entry point for llama3.1_local_rag - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/llama3.1_local_rag')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'llama3.1_local_rag.py')
