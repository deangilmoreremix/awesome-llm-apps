"""
Main entry point for ai_recruitment_agent_team - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/agent_teams/ai_recruitment_agent_team')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'ai_recruitment_agent_team.py')
