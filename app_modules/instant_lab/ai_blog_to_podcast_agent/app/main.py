"""
Main entry point for ai_blog_to_podcast_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './starter_ai_agents/ai_blog_to_podcast_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'blog_to_podcast_agent.py')
