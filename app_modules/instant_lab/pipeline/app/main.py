"""
Main entry point for pipeline - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/ai_news_and_podcast_agents/beifong/tools/pipeline')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'search_agent.py')
