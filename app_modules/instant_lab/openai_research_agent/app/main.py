"""
Main entry point for openai_research_agent - Instant Lab App
...
agent_path = os.path.join(project_root, 'starter_ai_agents', 'openai_research_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'research_agent.py')
