"""
Main entry point for github_mcp_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './mcp_ai_agents/github_mcp_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'github_agent.py')
