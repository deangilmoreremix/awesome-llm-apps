"""
Main entry point for helpers - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_llm_apps/chat-with-tarots/helpers')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'help_func.py')
