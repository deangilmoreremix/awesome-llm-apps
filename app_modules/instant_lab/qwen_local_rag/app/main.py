"""
Main entry point for qwen_local_rag - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/qwen_local_rag')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'qwen_local_rag_agent.py')
