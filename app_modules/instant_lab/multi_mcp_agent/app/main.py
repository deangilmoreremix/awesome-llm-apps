"""
Main entry point for multi_mcp_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './mcp_ai_agents/multi_mcp_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'multi_mcp_agent.py')
