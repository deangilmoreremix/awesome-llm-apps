"""
Main entry point for agentic_rag_gpt5 - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/agentic_rag_gpt5')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'agentic_rag_gpt5.py')
