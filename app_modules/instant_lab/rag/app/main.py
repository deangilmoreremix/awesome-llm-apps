"""
Main entry point for rag - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/agentic_rag_math_agent/rag')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'guardrails.py')
