"""
Main entry point for xai_finance_agent - Instant Lab App
...
agent_path = os.path.join(project_root, 'starter_ai_agents', 'xai_finance_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'xai_finance_agent.py')
