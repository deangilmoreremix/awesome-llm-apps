"""
Main entry point for ai_investment_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/single_agent_apps/ai_investment_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'investment_agent.py')
