"""
Main entry point for ai_data_visualisation_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './starter_ai_agents/ai_data_visualisation_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'ai_data_visualisation_agent.py')
