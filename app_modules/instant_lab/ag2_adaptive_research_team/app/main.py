"""
Main entry point for ag2_adaptive_research_team - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/agent_teams/ag2_adaptive_research_team')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'app.py')
