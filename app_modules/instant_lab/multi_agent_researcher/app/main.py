"""
Main entry point for multi_agent_researcher - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/multi_agent_researcher')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'research_agent_llama3.py')
