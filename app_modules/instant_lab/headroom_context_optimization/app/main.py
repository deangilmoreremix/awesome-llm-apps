"""
Main entry point for headroom_context_optimization - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_llm_apps/llm_optimization_tools/headroom_context_optimization')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'headroom_demo.py')
