"""
Main entry point for ai_recipe_meal_planning_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/single_agent_apps/ai_recipe_meal_planning_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'ai_recipe_meal_planning_agent.py')
