"""
Main entry point for agentic_rag_embedding_gemma - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/agentic_rag_embedding_gemma')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'agentic_rag_embeddinggemma.py')
