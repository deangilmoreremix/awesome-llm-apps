"""
Main entry point for ai_home_renovation_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/ai_home_renovation_agent')
