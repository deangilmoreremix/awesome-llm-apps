"""
Main entry point for ai_music_generator_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './starter_ai_agents/ai_music_generator_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'music_generator_agent.py')
