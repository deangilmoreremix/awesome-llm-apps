"""
Main entry point for ai_email_gtm_reachout_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/single_agent_apps/ai_email_gtm_reachout_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'ai_email_gtm_reachout.py')
