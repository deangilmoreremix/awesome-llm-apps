"""
Main entry point for multi_llm_memory - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_llm_apps/llm_apps_with_memory_tutorials/multi_llm_memory')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'multi_llm_memory.py')
