"""
Main entry point for app - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/agentic_rag_math_agent/app')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'benchmark.py')
