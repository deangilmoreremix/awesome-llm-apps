"""
Main entry point for web_scraping_ai_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './starter_ai_agents/web_scraping_ai_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'local_ai_scrapper.py')
