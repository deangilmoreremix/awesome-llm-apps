"""
Main entry point for ai_domain_deep_research_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/ai_domain_deep_research_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'ai_domain_deep_research_agent.py')
