"""
Main entry point for rag_failure_diagnostics_clinic - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/rag_failure_diagnostics_clinic')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'rag_failure_diagnostics_clinic.py')
