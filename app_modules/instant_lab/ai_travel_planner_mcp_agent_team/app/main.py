"""
Main entry point for ai_travel_planner_mcp_agent_team - Instant Lab App
...
agent_path = os.path.join(project_root, './mcp_ai_agents/ai_travel_planner_mcp_agent_team')
