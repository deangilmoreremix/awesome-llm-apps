"""
Main entry point for chat_with_pdf - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_llm_apps/chat_with_X_tutorials/chat_with_pdf')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'chat_pdf_llama3.2.py')
