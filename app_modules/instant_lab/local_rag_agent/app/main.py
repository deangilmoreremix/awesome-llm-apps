"""
Main entry point for local_rag_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/local_rag_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'local_rag_agent.py')
