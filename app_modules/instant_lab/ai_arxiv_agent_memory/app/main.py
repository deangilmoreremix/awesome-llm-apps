"""
Main entry point for ai_arxiv_agent_memory - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_llm_apps/llm_apps_with_memory_tutorials/ai_arxiv_agent_memory')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'ai_arxiv_agent_memory.py')
