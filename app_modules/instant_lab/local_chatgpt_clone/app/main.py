"""
Main entry point for local_chatgpt_clone - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_llm_apps/cursor_ai_experiments/local_chatgpt_clone')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'chatgpt_clone_llama3.py')
