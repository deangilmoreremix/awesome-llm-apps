"""
Main entry point for router - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/agent_teams/ai_travel_planner_agent_team/backend/router')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'plan.py')
