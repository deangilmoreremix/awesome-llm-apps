"""
Main entry point for ai_tic_tac_toe_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/autonomous_game_playing_agent_apps/ai_tic_tac_toe_agent')
