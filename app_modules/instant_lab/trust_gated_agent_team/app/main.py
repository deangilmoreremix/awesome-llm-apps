"""
Main entry point for trust_gated_agent_team - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/trust_gated_agent_team')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'trust_gated_agents.py')
