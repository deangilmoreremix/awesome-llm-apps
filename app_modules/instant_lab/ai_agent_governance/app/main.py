"""
Main entry point for ai_agent_governance - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/single_agent_apps/ai_agent_governance')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'ai_agent_governance.py')
