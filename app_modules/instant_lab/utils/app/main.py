"""
Main entry point for utils - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/ai_news_and_podcast_agents/beifong/utils')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'load_api_keys.py')
