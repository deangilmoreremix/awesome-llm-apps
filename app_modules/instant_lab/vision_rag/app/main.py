"""
Main entry point for vision_rag - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/vision_rag')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'vision_rag.py')
