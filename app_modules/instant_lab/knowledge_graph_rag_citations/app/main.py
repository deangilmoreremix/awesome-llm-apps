"""
Main entry point for knowledge_graph_rag_citations - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/knowledge_graph_rag_citations')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'knowledge_graph_rag.py')
