"""
Main entry point for research_agent_gemini_interaction_api - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/single_agent_apps/research_agent_gemini_interaction_api')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'research_planner_executor_agent.py')
