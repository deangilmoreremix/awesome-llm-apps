"""
Main entry point for agentic_rag_with_reasoning - Instant Lab App
...
agent_path = os.path.join(project_root, './rag_tutorials/agentic_rag_with_reasoning')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'rag_reasoning_agent.py')
