"""
Main entry point for gemma3_finetuning - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_llm_apps/llm_finetuning_tutorials/gemma3_finetuning')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'finetune_gemma3.py')
