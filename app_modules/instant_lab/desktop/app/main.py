"""
Main entry point for desktop - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/single_agent_apps/windows_use_autonomous_agent/windows_use/desktop')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'config.py')
