"""
Main entry point for chat_with_youtube_videos - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_llm_apps/chat_with_X_tutorials/chat_with_youtube_videos')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'test_session_state.py')
