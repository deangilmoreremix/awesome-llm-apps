"""
Main entry point for ai_aqi_analysis_agent - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/ai_aqi_analysis_agent')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'ai_aqi_analysis_agent_gradio.py')
