"""
Main entry point for db - Instant Lab App
...
agent_path = os.path.join(project_root, './advanced_ai_agents/multi_agent_apps/ai_news_and_podcast_agents/beifong/db')
...
def main():
    ...
    agent_script = os.path.join(agent_path, 'tasks.py')
